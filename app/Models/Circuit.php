...
class Circuit extends Model
{
    ...
    protected $casts = [
        ...
        'availability' => 'array',
        'pickup_times' => 'array',
        'price_adult_eur' => 'array',
        'price_child_eur' => 'array',
    ];

    /**
     * Get the category that owns the circuit.
     */
    ...
    /**
     * Get the destination that owns the circuit.
     */
    ...
    /**
     * Get the bookings for the circuit.
     */
    ...
    /**
     * Get the reviews for the circuit.
     */
